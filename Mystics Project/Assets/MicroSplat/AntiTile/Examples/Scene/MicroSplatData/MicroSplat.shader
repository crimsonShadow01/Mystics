...
Shader "MicroSplat/Example_AntiTiling" {
   Properties {
   ...
   SubShader {
     ...
     #pragma instancing_options assumeuniformscaling nomatrices nolightprobe nolightmap forwardadd
      ...
      #define _DISTANCERESAMPLEALBEDOBLENDLIGHTERCOLOR 1
...
ENDCG
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Example_AntiTiling_Base-828111157"
