...
namespace JBooth.MicroSplat
{
    public abstract class FeatureDescriptor
    {
        ...
        public virtual void OnPostGeneration(StringBuilder sb, string[] features, string name, string baseName = null, MicroSplatShaderGUI.MicroSplatCompiler.AuxShader auxShader = null) { }
