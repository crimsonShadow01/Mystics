    ...
    public partial class TerrainPainterWindow : EditorWindow
    {
        ...
        void InitTerrains()
        {
            ...
            for (int i = 0; i < objs.Length; ++i)
            {
               ...
               if (hasBiome && mst.procBiomeMask == null)
               {
                  mst.procBiomeMask = CreateTexture (t, mst.procBiomeMask, "_biome", new Color (1, 1, 1, 1));
               }
               if (hasBiome2 && mst.procBiomeMask2 == null)
               {
                  mst.procBiomeMask2 = CreateTexture (t, mst.procBiomeMask2, "_biome2", new Color (1, 1, 1, 1));
               }
#endif
