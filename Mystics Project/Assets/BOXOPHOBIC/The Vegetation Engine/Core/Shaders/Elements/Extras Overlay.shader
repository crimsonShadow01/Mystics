	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half lerpResult654_g18625 = lerp( 1.0 , ( 1.0 - saturate( ( pow( saturate( ( ( abs( (( (TVE_VolumeCoord).zw + ( (TVE_VolumeCoord).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g18652 ) ) ) , 2.0 ).x + 0.0 ) ) ) , Enable_Fade_Support454_g18625);
				...
				half4 break469_g18625 = saturate( ( ( tex2DNode17_g18625 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g18647 ) ) );
...
ASEEND*/
//CHKSM=F26FBAA289023256997DD1EB8E841C330BA039F4