	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 Mesh_PivotsOS2291_g31445 = _Vector1;
				float3 temp_output_2283_0_g31445 = ( inputMesh.positionOS - Mesh_PivotsOS2291_g31445 );
				half3 VertexPos40_g32429 = temp_output_2283_0_g31445;
				...
				float Bounds_Height374_g31445 = _MaxBoundsInfo.y;
				float WorldData19_g32403 = ( Bounds_Height374_g31445 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g32403 = WorldData19_g32403;
				#else
				float staticSwitch14_g32403 = ObjectData20_g32403;
				#endif
				float Motion_Max_Bending1133_g31445 = staticSwitch14_g32403;
				...
				half Wind_Power_103106_g31445 = Wind_Power369_g32350;
				...
				half2 Wind_DirectionOS39_g31445 = (temp_output_339_0_g32350).xz;
				half Motion_Use1056_g31445 = _Motion_10;
				...
				half Global_NoiseTex_R34_g31445 = break142_g32370.r;
				...
				#endif
				half Variation3073_g31445 = staticSwitch14_g32408;
				half Motion_Variation284_g32427 = ( _MotionVariation_10 * Variation3073_g31445 );
				...
				half Input_Turbulence327_g32427 = Global_NoiseTex_R34_g31445;
				float2 lerpResult321_g32427 = lerp( Sine_MinusOneToOne281_g32427 , temp_cast_11 , Input_Turbulence327_g32427);
				half2 Motion_Bending2258_g31445 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g31445 ) * Wind_Power_103106_g31445 * Wind_DirectionOS39_g31445 * Motion_Use1056_g31445 * Global_NoiseTex_R34_g31445 * lerpResult321_g32427 );
				half Motion_UseInteraction2097_g31445 = _Motion_Interaction;
				half Motion_InteractionMask66_g31445 = break322_g32350.w;
				float lerpResult3307_g31445 = lerp( 1.0 , Variation3073_g31445 , _InteractionVariation);
				half2 Motion_Interaction53_g31445 = ( _InteractionAmplitude * Motion_Max_Bending1133_g31445 * Motion_UseInteraction2097_g31445 * Motion_InteractionMask66_g31445 * Motion_InteractionMask66_g31445 * Wind_DirectionOS39_g31445 * lerpResult3307_g31445 );
				float2 lerpResult109_g31445 = lerp( Motion_Bending2258_g31445 , Motion_Interaction53_g31445 , Motion_InteractionMask66_g31445);
				half Mesh_Motion_182_g31445 = inputMesh.ase_texcoord3.x;
				float2 break143_g31445 = ( lerpResult109_g31445 * Mesh_Motion_182_g31445 );
				half Motion_Z190_g31445 = break143_g31445.y;
				half Angle44_g32429 = Motion_Z190_g31445;
				...
				half Motion_X216_g31445 = break143_g31445.x;
				half Angle44_g32421 = -Motion_X216_g31445;
				half Wind_Mode3167_g31445 = TVE_WindMode;
				float3 lerpResult3168_g31445 = lerp( inputMesh.positionOS , ( VertexPosRotationAxis50_g32421 + ( VertexPosOtherAxis82_g32421 * cos( Angle44_g32421 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g32421 ) * sin( Angle44_g32421 ) ) ) , Wind_Mode3167_g31445);
				float3 Vertex_Motion_Object833_g31445 = lerpResult3168_g31445;
				float3 appendResult2043_g31445 = (float3(Motion_X216_g31445 , 0.0 , Motion_Z190_g31445));
				float3 lerpResult3173_g31445 = lerp( inputMesh.positionOS , ( inputMesh.positionOS + appendResult2043_g31445 ) , Wind_Mode3167_g31445);
				float3 Vertex_Motion_World1118_g31445 = lerpResult3173_g31445;
				float3 temp_output_3331_0_g31445 = ( ( _VertexCat * _VertexMotionSpace * _VertexMotionMode * _VertexDataMode ) + Vertex_Motion_World1118_g31445 );
				#if defined(TVE_VERTEX_DATA_OBJECT)
				float3 staticSwitch3312_g31445 = Vertex_Motion_Object833_g31445;
				#elif defined(TVE_VERTEX_DATA_WORLD)
				float3 staticSwitch3312_g31445 = temp_output_3331_0_g31445;
				#elif defined(TVE_VERTEX_DATA_BATCHED)
				float3 staticSwitch3312_g31445 = temp_output_3331_0_g31445;
				#else
				float3 staticSwitch3312_g31445 = Vertex_Motion_Object833_g31445;
				#endif
				half3 ObjectData20_g32349 = staticSwitch3312_g31445;
				half3 WorldData19_g32349 = Vertex_Motion_World1118_g31445;
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				#endif
				float Vertex_SizeFade1740_g31445 = staticSwitch14_g32364;
				...
				half Global_ExtrasTex_G305_g31445 = break49_g32352.y;
				float lerpResult346_g31445 = lerp( 1.0 , Global_ExtrasTex_G305_g31445 , _GlobalSize);
				float ObjectData20_g32363 = ( lerpResult346_g31445 * _LocalSize );
				...
				#endif
				half Vertex_Size1741_g31445 = staticSwitch14_g32363;
				half3 Grass_Coverage2661_g31445 = half3(0,0,0);
				float3 Final_VertexPosition890_g31445 = ( ( staticSwitch14_g32349 * Vertex_SizeFade1740_g31445 * Vertex_Size1741_g31445 ) + Mesh_PivotsOS2291_g31445 + Grass_Coverage2661_g31445 );
				
				half2 Noise_UVs3274_g31445 = ( (ase_worldPos).xz * ( ( _NoiseScaleValue * 0.1 ) + _MoiseCat ) );
				float temp_output_7_0_g32314 = _NoiseMinValue;
				half Noise_Mask3162_g31445 = saturate( ( ( tex2Dlod( _NoiseTex, float4( Noise_UVs3274_g31445, 0, 0.0) ).r - temp_output_7_0_g32314 ) / ( _NoiseMaxValue - temp_output_7_0_g32314 ) ) );
				float4 lerpResult2800_g31445 = lerp( _NoiseTintTwo , _NoiseTintOne , Noise_Mask3162_g31445);
				half3 Noise_Tint2802_g31445 = (lerpResult2800_g31445).rgb;
				float3 vertexToFrag3225_g31445 = Noise_Tint2802_g31445;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3225_g31445;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g31445;
						...
						)
			{
				...
				float4 lerpResult2779_g31445 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g32317 ) / ( ( _GradientMaxValue + _GradientCat ) - temp_output_7_0_g32317 ) ) ));
				half3 Gradient_Tint2784_g31445 = (lerpResult2779_g31445).rgb;
				float3 vertexToFrag3225_g31445 = packedInput.ase_texcoord5.xyz;
				half2 Main_UVs15_g31445 = ( ( packedInput.ase_texcoord6.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g31445 = tex2D( _MainAlbedoTex, Main_UVs15_g31445 );
				float4 temp_output_51_0_g31445 = ( _MainColor * tex2DNode29_g31445 );
				half3 Main_AlbedoRaw99_g31445 = (temp_output_51_0_g31445).rgb;
				half3 Main_AlbedoTinted2808_g31445 = ( Gradient_Tint2784_g31445 * vertexToFrag3225_g31445 * Main_AlbedoRaw99_g31445 * float3(1,1,1) );
				...
				half3 Global_ColorsTex_RGB1700_g31445 = (temp_output_45_0_g32385).xyz;
				float4 tex2DNode35_g31445 = tex2D( _MainMaskTex, Main_UVs15_g31445 );
				half Main_Mask_Raw57_g31445 = tex2DNode35_g31445.b;
				float temp_output_7_0_g32405 = _MainMaskMinValue;
				half Main_Mask_Remap3201_g31445 = saturate( ( ( Main_Mask_Raw57_g31445 - temp_output_7_0_g32405 ) / ( _MainMaskMaxValue - temp_output_7_0_g32405 ) ) );
				float lerpResult2105_g31445 = lerp( 1.0 , Main_Mask_Remap3201_g31445 , _ColorsMaskValue);
				float3 lerpResult108_g31445 = lerp( float3( 1,1,1 ) , ( (_LocalColors).rgb * ( Global_ColorsTex_RGB1700_g31445 * 4.594794 ) ) , ( _GlobalColors * lerpResult2105_g31445 ));
				half3 Global_Colors1954_g31445 = lerpResult108_g31445;
				float3 temp_output_123_0_g31445 = ( Main_AlbedoTinted2808_g31445 * Global_Colors1954_g31445 );
				half3 Main_AlbedoColored863_g31445 = temp_output_123_0_g31445;
				half3 Blend_Albedo265_g31445 = Main_AlbedoColored863_g31445;
				float3 lerpResult2929_g31445 = lerp( float3( 1,1,1 ) , (TVE_MainLightParams).rgb , _SubsurfaceLightValue);
				half3 Subsurface_Color1722_g31445 = ( (_SubsurfaceColor).rgb * lerpResult2929_g31445 );
				half Global_ColorsTex_A1701_g31445 = (temp_output_45_0_g32385).w;
				float lerpResult1720_g31445 = lerp( 1.0 , Global_ColorsTex_A1701_g31445 , _GlobalHealthiness);
				half Subsurface_Intensity1752_g31445 = ( ( _SubsurfaceValue * lerpResult1720_g31445 ) + _SubsurfaceCat );
				float lerpResult3210_g31445 = lerp( 1.0 , Main_Mask_Remap3201_g31445 , _SubsurfaceMaskValue);
				half Subsurface_Mask1557_g31445 = lerpResult3210_g31445;
				half3 Subsurface_Transmission884_g31445 = ( Subsurface_Color1722_g31445 * Subsurface_Intensity1752_g31445 * Subsurface_Mask1557_g31445 );
				float3 normalizeResult1983_g31445 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float dotResult785_g31445 = dot( -TVE_MainLightDirection , normalizeResult1983_g31445 );
				float saferPower1624_g31445 = max( (dotResult785_g31445*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g31445 = 0.0;
				#else
				float staticSwitch1602_g31445 = ( pow( saferPower1624_g31445 , _SubsurfaceAngleValue ) * _SubsurfaceViewValue );
				#endif
				half Mask_Subsurface_View782_g31445 = staticSwitch1602_g31445;
				half3 Subsurface_Deferred1693_g31445 = ( Subsurface_Transmission884_g31445 * Mask_Subsurface_View782_g31445 );
				half3 Blend_AlbedoAndSubsurface149_g31445 = ( Blend_Albedo265_g31445 + Subsurface_Deferred1693_g31445 );
				half3 Global_OverlayColor1758_g31445 = (TVE_OverlayColor).rgb;
				float4 tex2DNode117_g31445 = tex2D( _MainNormalTex, Main_UVs15_g31445 );
				float2 appendResult88_g32418 = (float2(tex2DNode117_g31445.a , tex2DNode117_g31445.g));
				...
				half Main_NormalY2095_g31445 = break93_g32418.y;
				half Overlay_Contrast1405_g31445 = _OverlayContrastValue;
				half Global_OverlayIntensity154_g31445 = TVE_OverlayIntensity;
				float3 localObjectPosition_UNITY_MATRIX_M14_g32355 = ObjectPosition_UNITY_MATRIX_M();
				half3 Off19_g32358 = localObjectPosition_UNITY_MATRIX_M14_g32355;
				...
				half4 localUSE_BUFFERS33_g32353 = USE_BUFFERS( Legacy33_g32353 , Vegetation33_g32353 , Grass33_g32353 , Objects33_g32353 , Custom33_g32353 );
				float4 break49_g32352 = localUSE_BUFFERS33_g32353;
				half Global_ExtrasTex_B156_g31445 = break49_g32352.z;
				float temp_output_1025_0_g31445 = ( Global_OverlayIntensity154_g31445 * _GlobalOverlay * Global_ExtrasTex_B156_g31445 );
				half Overlay_Commons1365_g31445 = temp_output_1025_0_g31445;
				half Overlay_Mask269_g31445 = saturate( ( saturate( ( packedInput.ase_color.a + ( Main_NormalY2095_g31445 * Overlay_Contrast1405_g31445 ) ) ) - ( 1.0 - Overlay_Commons1365_g31445 ) ) );
				float3 lerpResult336_g31445 = lerp( Blend_AlbedoAndSubsurface149_g31445 , Global_OverlayColor1758_g31445 , Overlay_Mask269_g31445);
				half3 Final_Albedo359_g31445 = lerpResult336_g31445;
				half Main_Alpha316_g31445 = (temp_output_51_0_g31445).a;
				float lerpResult354_g31445 = lerp( 1.0 , Main_Alpha316_g31445 , _render_premul);
				half Final_Premultiply355_g31445 = lerpResult354_g31445;
				float3 temp_output_410_0_g31445 = ( Final_Albedo359_g31445 * Final_Premultiply355_g31445 );
				
				float3 appendResult91_g32418 = (float3(temp_output_90_0_g32418 , 1.0));
				half3 Main_Normal137_g31445 = appendResult91_g32418;
				float3 temp_output_13_0_g32320 = Main_Normal137_g31445;
				float3 switchResult12_g32320 = (((isFrontFace>0)?(temp_output_13_0_g32320):(( temp_output_13_0_g32320 * _render_normals_options ))));
				half3 Blend_Normal312_g31445 = switchResult12_g32320;
				half3 Final_Normal366_g31445 = Blend_Normal312_g31445;
				
				half Main_Smoothness227_g31445 = ( tex2DNode35_g31445.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g31445 = Main_Smoothness227_g31445;
				half Global_OverlaySmoothness311_g31445 = TVE_OverlaySmoothness;
				float lerpResult343_g31445 = lerp( Blend_Smoothness314_g31445 , Global_OverlaySmoothness311_g31445 , Overlay_Mask269_g31445);
				half Final_Smoothness371_g31445 = lerpResult343_g31445;
				half Global_Wetness1016_g31445 = ( TVE_Wetness * _GlobalWetness );
				half Global_ExtrasTex_A1033_g31445 = break49_g32352.w;
				float lerpResult1037_g31445 = lerp( Final_Smoothness371_g31445 , saturate( ( Final_Smoothness371_g31445 + Global_Wetness1016_g31445 ) ) , Global_ExtrasTex_A1033_g31445);
				
				float lerpResult240_g31445 = lerp( 1.0 , tex2DNode35_g31445.g , _MainOcclusionValue);
				half Main_Occlusion247_g31445 = lerpResult240_g31445;
				half Blend_Occlusion323_g31445 = Main_Occlusion247_g31445;
				
				float localCustomAlphaClip9_g32414 = ( 0.0 );
				half Main_AlphaRaw1203_g31445 = tex2DNode29_g31445.a;
				float3 normalizeResult2169_g31445 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				...
				float3 tanNormal2274_g31445 = half3(0.001,0.001,1);
				float3 worldNormal2274_g31445 = float3(dot(tanToWorld0,tanNormal2274_g31445), dot(tanToWorld1,tanNormal2274_g31445), dot(tanToWorld2,tanNormal2274_g31445));
				float dotResult2161_g31445 = dot( normalizeResult2169_g31445 , worldNormal2274_g31445 );
				float3 normalizeResult2210_g31445 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float dotResult2212_g31445 = dot( normalizeResult2210_g31445 , float3(0,1,0) );
				half Mask_HView2656_g31445 = abs( dotResult2212_g31445 );
				float lerpResult2221_g31445 = lerp( _BillboardFadeHValue , _BillboardFadeVValue , Mask_HView2656_g31445);
				half Billboard_Fade2175_g31445 = ( pow( ( dotResult2161_g31445 * dotResult2161_g31445 ) , lerpResult2221_g31445 ) + _BillboardCat );
				half Alpha5_g32414 = ( Main_AlphaRaw1203_g31445 * Billboard_Fade2175_g31445 );
				float Alpha9_g32414 = Alpha5_g32414;
				#if _ALPHATEST_ON
				clip(Alpha9_g32414 - _Cutoff);
				#endif
				half Final_Clip914_g31445 = localCustomAlphaClip9_g32414;
				
				surfaceDescription.Albedo = temp_output_410_0_g31445;
				surfaceDescription.Normal = Final_Normal366_g31445;
				...
				surfaceDescription.Smoothness = lerpResult1037_g31445;
				surfaceDescription.Occlusion = Blend_Occlusion323_g31445;
				surfaceDescription.Alpha = Main_Alpha316_g31445;

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = Final_Clip914_g31445;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half3 Noise_Tint2802_g31445 = (lerpResult2800_g31445).rgb;
				float3 vertexToFrag3225_g31445 = Noise_Tint2802_g31445;
				outputPackedVaryingsMeshToPS.ase_texcoord.xyz = vertexToFrag3225_g31445;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 lerpResult2779_g31445 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g32317 ) / ( ( _GradientMaxValue + _GradientCat ) - temp_output_7_0_g32317 ) ) ));
				half3 Gradient_Tint2784_g31445 = (lerpResult2779_g31445).rgb;
				float3 vertexToFrag3225_g31445 = packedInput.ase_texcoord.xyz;
				half2 Main_UVs15_g31445 = ( ( packedInput.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g31445 = tex2D( _MainAlbedoTex, Main_UVs15_g31445 );
				float4 temp_output_51_0_g31445 = ( _MainColor * tex2DNode29_g31445 );
				half3 Main_AlbedoRaw99_g31445 = (temp_output_51_0_g31445).rgb;
				half3 Main_AlbedoTinted2808_g31445 = ( Gradient_Tint2784_g31445 * vertexToFrag3225_g31445 * Main_AlbedoRaw99_g31445 * float3(1,1,1) );
		...
		Pass
		{
					...
					)
			{
				...
				half2 Main_UVs15_g31445 = ( ( packedInput.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode117_g31445 = tex2D( _MainNormalTex, Main_UVs15_g31445 );
				float2 appendResult88_g32418 = (float2(tex2DNode117_g31445.a , tex2DNode117_g31445.g));
				float2 temp_output_90_0_g32418 = ( (appendResult88_g32418*2.0 + -1.0) * _MainNormalValue );
				float3 appendResult91_g32418 = (float3(temp_output_90_0_g32418 , 1.0));
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				half3 Noise_Tint2802_g31445 = (lerpResult2800_g31445).rgb;
				float3 vertexToFrag3225_g31445 = Noise_Tint2802_g31445;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3225_g31445;
						...
						)
			{
				...
				float4 lerpResult2779_g31445 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g32317 ) / ( ( _GradientMaxValue + _GradientCat ) - temp_output_7_0_g32317 ) ) ));
				half3 Gradient_Tint2784_g31445 = (lerpResult2779_g31445).rgb;
				float3 vertexToFrag3225_g31445 = packedInput.ase_texcoord7.xyz;
				half2 Main_UVs15_g31445 = ( ( packedInput.ase_texcoord8.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g31445 = tex2D( _MainAlbedoTex, Main_UVs15_g31445 );
				float4 temp_output_51_0_g31445 = ( _MainColor * tex2DNode29_g31445 );
				half3 Main_AlbedoRaw99_g31445 = (temp_output_51_0_g31445).rgb;
				half3 Main_AlbedoTinted2808_g31445 = ( Gradient_Tint2784_g31445 * vertexToFrag3225_g31445 * Main_AlbedoRaw99_g31445 * float3(1,1,1) );
...
/*ASEBEGIN
Version=18600
1927;7;1906;1015;2850.668;1077.407;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;287;-1552,-768;Half;False;Property;_render_dst;_render_dst;211;1;[HideInInspector];Create;True;2;Opaque;0;Transparent;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;275;-2176,-384;Inherit;False;Base Shader;1;;31445;856f7164d1c579d43a5cf4968a75ca43;50,1300,1,1298,1,1271,0,1708,1,1962,1,1712,3,1964,1,1969,1,1719,1,893,0,1745,1,1742,1,1718,1,1717,1,1715,1,1714,1,916,0,1949,1,1762,0,1763,0,1776,0,1646,1,1690,1,1757,0,3221,3,1981,0,2807,1,2953,1,3243,0,2172,1,2658,0,1734,0,1737,0,1733,0,1736,0,1968,0,1966,0,1735,0,878,0,1550,0,860,1,2750,0,2260,1,2261,1,2054,0,2032,0,2036,0,2060,0,2062,0,2039,0;0;15;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
...
Node;AmplifyShaderEditor.RangedFloatNode;291;-2176,-768;Half;False;Property;_render_cutoff;_render_cutoff;208;1;[HideInInspector];Create;True;4;Alpha;0;Premultiply;1;Additive;2;Multiply;3;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;290;-1920,-768;Half;False;Property;_render_cull;_render_cull;209;1;[HideInInspector];Create;True;3;Both;0;Back;1;Front;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;289;-1744,-768;Half;False;Property;_render_src;_render_src;210;1;[HideInInspector];Create;True;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;288;-1376,-768;Half;False;Property;_render_zw;_render_zw;212;1;[HideInInspector];Create;True;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;278;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;279;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;284;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;283;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;True;-44;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;280;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;276;-1376,-384;Float;False;True;-1;2;TVEShaderCoreGUI;0;2;BOXOPHOBIC/The Vegetation Engine/Vegetation/Cross Standard Lit;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;1;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;0;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;1;LOD CrossFade;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;0;0;11;True;True;True;True;True;False;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;281;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;277;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;282;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;285;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;286;-1376,-384;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;0;True;-28;False;True;True;True;True;True;0;True;-44;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
...
WireConnection;276;1;275;528
WireConnection;276;7;275;530
WireConnection;276;8;275;531
WireConnection;276;9;275;532
WireConnection;276;10;275;653
WireConnection;276;11;275;534
ASEEND*/
//CHKSM=6509EDBA7574C7C05AEF99A6CBF462FA3567C12C